      ...
      <main className="flex-grow">
        <Container>
          <div className="py-12 md:py-20">
              ...
              <div className="md:col-span-1 space-y-8">
                ...
                <div className="p-6">
                  ...
                  <div className="flex space-x-4">
                    <a href="#" className="text-gray-700 dark:text-gray-300 hover:text-primary dark:hover:text-primary transition-colors">
                ...
                <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 md:p-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="md:col-span-2">
                      <Button 
                        type="submit" 
                        className="w-full bg-gradient-to-r from-purple-600 to-violet-500 hover:from-purple-600 hover:to-violet-600"
            ...
            {/* Map Section */}
            <div className="border rounded-lg overflow-hidden h-80 bg-gray-100 dark:bg-gray-800 flex items-center justify-center">
